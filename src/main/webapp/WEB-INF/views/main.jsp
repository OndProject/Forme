        ...
        <header>
          ...
          <nav>
            <ul>
                ...
                <li><a href="" class ="login"><button type="button" class="btn btn text-white" style="background-color: rgb(47, 153, 244);"><b>로그인</b></button></a></li>
            </ul>
          </nav>
        </header>
      </div> <!--헤더 end-->
            ...
            <div class="p_row">
              ...
              <div class="col-md-10">
                ...
                <div class = "p_article" onclick="location.href='http://google.com'">
                    <div class = "p_class"><a href ="#"><img src="resources/images/popular/class1.jpg" alt="..." class="p_img"></a></div>
                    <a href ="#"><p class = "p_small"><b>강사명</b></p></a>
                    <a href ="#"><p class ="p_title">강습 제목</p></a>
                ...
                <div class = "p_article" onclick="location.href='http://google.com'">
                    <div class = "p_class"><a href ="#"><img src="resources/images/popular/class2.jpg" alt="..." class="p_img"></a></div>
                    <a href ="#"><p class = "p_small"><b>강사명</b></p></a>
                    <a href ="#"><p class ="p_title">강습 제목</p></a>
                    <a href ="#"><p class ="p_price"><i class="bi bi-basket2">&nbsp</i><b>30,000원~</b></p></a>
                    <a href ="#"><p class ="p_star"><i class="bi bi-star-fill"></i>4.8</a> | 200개의 리뷰</p>
                ...
                <div class = "p_article" onclick="location.href='http://google.com'">
                    <div class = "p_class"><a href ="#"><img src="resources/images/popular/class3.jpg" alt="..." class="p_img"></a></div>
                    <a href ="#"><p class = "p_small"><b>강사명</b></p></a>
                    <a href ="#"><p class ="p_title">강습 제목</p></a>
                    <a href ="#"><p class ="p_price"><i class="bi bi-basket2">&nbsp</i><b>30,000원~</b></p></a>
                    <a href ="#"><p class ="p_star"><i class="bi bi-star-fill"></i>4.8</a> | 200개의 리뷰</p>
                ...
                <div class = "p_article" onclick="location.href='http://google.com'">
                    <div class = "p_class"><a href ="#"><img src="resources/images/popular/class4.jpg" alt="..." class="p_img"></a></div>
                    <a href ="#"><p class = "p_small"><b>강사명</b></p></a>
                    <a href ="#"><p class ="p_title">강습 제목</p></a>
                    <a href ="#"><p class ="p_price"><i class="bi bi-basket2">&nbsp</i><b>30,000원~</b></p></a>
                    <a href ="#"><p class ="p_star"><i class="bi bi-star-fill"></i>4.8</a> | 200개의 리뷰</p>
